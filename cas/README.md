...
[Luxor AB](https://en.wikipedia.org/wiki/Luxor_AB) could naturally
also provide the tape recorder: __ABC820__.
...
Latin G0 na - tional option subsets
...
Prerequisites: install or make sure you have `Python3` and `gcc`
(or equivalent) and optional `make`. Compile 
'[wav2bin.c](tobasic/wav2bin.c)' to an executable.
...
- *Luxor Service Manual ABC80 190 9589* (printed service manual) [URL](https://www.abc80.org/docs/abc80_servicemanual.pdf)
