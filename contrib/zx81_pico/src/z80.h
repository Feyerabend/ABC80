...
extern u8 port_in(u8 hi, u8 port);
...
/* T-states consumed by the most recently executed instruction (set by step()). */
int z80_ts;

/* Set by cjr/ccall/cret when a conditional branch is taken; cleared by step(). */
bv _cond_taken;
